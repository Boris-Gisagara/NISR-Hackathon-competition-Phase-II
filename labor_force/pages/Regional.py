...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# Load the shapefile
shapefile_path = r"C:\Users\user\OneDrive\Documents\python works\labor_force\RwShapeFile\Rwanda.shp"
gdf = gpd.read_file(shapefile_path)
gdf.rename(columns={'ADM2_EN': 'Districts'}, inplace=True)

# Load the employment data
employment_data_path = r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Districts.xlsx"
