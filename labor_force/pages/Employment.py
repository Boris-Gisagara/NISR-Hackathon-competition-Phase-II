...
formal_sector = pd.read_excel(r'C:\Users\user\Downloads\formal_sector.xlsx')

informal_sector = pd.read_excel(r'C:\Users\user\Downloads\informal_sector.xlsx')

formal_sector_out_of_agri = pd.read_excel(r'C:\Users\user\Downloads\formal_sector_out_of_agri.xlsx')

informal_sector_out_of_agri = pd.read_excel(r'C:\Users\user\Downloads\informal_sector_out_of_agri.xlsx')


#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
#data for the employment status in rwanda for the heatmap
# Load the data
economic_activity_df = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Economic.xlsx")
age_range_df = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Age_range.xlsx")
occupation_df = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Occupations.xlsx")

#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
#data for job creation and working time
Job_creation = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Job_creation.xlsx")
# Define income ranges for dropdown options
income_ranges = Job_creation['Income'].tolist()
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
#data for the income section
Age_rangeInc=pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\IncAge_range.xlsx")
Education_levelInc=pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\IncEducation_level.xlsx")
OccupationInc=pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\IncOccupation.xlsx")
datasetsIncome = {
...
workingTime=pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\working_Time.xlsx")
...
layout = dbc.Container([
        html.Br(),
        html.Br(),
        html.H1('Labor_Underutilization',style={'textAlign':'center','fontSize': '30px','color': 'black','fontFamily':'Roboto Slab'},className='m-3'),
        html.Br(),
        # Horizontal frame for the title for "The Labor Force" section
        html.Div(
            [
                html.H3("Employment Status in Rwanda", style={'color': 'black', 'backgroundColor': '#2fc2df', 'padding': '10px'}),
            ],
        ...
        dbc.Row([
            dbc.Col([
                html.Div([
                    # html.Div([
                    #     html.H3("tttttttttttttttt", style={'fontSize':'20px','color': 'black','textAlign':'center', 'margin': '0 auto'})
        ...
        dbc.Row([
            html.Div(
                [
                    html.H3("Employment at main Job in Formal and Informal Sectors by Gender/Residence and agriculture", style={'color': 'black', 'backgroundColor': '#2fc2df', 'padding': '10px'}),
                ],
...
#-------------------------------------------------------------------------------------------------------------------------------
        ...
        dbc.Row([
            html.Div(
                [
                    html.H3("Job creation and Working Time", style={'color': 'black', 'backgroundColor': '#2fc2df', 'padding': '10px'}),
                ],
                style={'textAlign': 'center'}
            ),
            dbc.Col([
                html.Div([
                    html.Div([
                        html.H3("Size distribution of monthly cash income from employment", style={'fontSize':'20px','color': 'black','textAlign':'center', 'margin': '0 auto'})
                    ],className="border-start border-primary border-5 m-4", style={'height': '40px'}
                    ),
                    html.Hr(style={'color': 'black', 'width': '90%', 'margin': '0 auto'}),
                    html.Div([
                        ...
                        dbc.Col(
                            dbc.Card([
                                dbc.CardBody([
                                    ...
                                    html.Div("Labour Force Population", style={'fontSize': '16px','color': 'black'}),
            ...
            dbc.Col([
                html.Div([
                    html.Div([
                        html.H3('Employed population with working time in Rwanda-Rural Urban', style={'color': 'black','textAlign':'center', 'margin': '0 auto'}),
                    ],className="border-start border-primary border-5 m-4", style={'height': '40px'}),
                    html.Hr(style={'color': 'black', 'width': '90%', 'margin': '0 auto'}),
