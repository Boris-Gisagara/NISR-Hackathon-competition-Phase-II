...
dfUnempl = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\unemployment.xlsx")
# Load the data for underutilization by age group
dfunder1=pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\underutilizatoin1.xlsx")
# Load the data for underutilization by underutilisation
dfUnder2 = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\underutilization2.xlsx")
# Load the dataset for self reported status
selfRep = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\selfRep.xlsx")
#-----------------------------------------------------------------------------------------------------------------------------------------------------
# Load the data for livelihood source
livelihood = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\livelihoodSource.xlsx")
...
Reasons = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\ReasonsOut.xlsx")
#---------------------------------------------------------------------------------Unemplyment page layout-------------------------------------------------------------------------------
# load the data for unemployment
df_age = pd.read_excel("C:/Users/user/OneDrive/Documents/python works/labor_force/dataset/unemploymentAge.xlsx")

df_edu = pd.read_excel("C:/Users/user/OneDrive/Documents/python works/labor_force/dataset/unemploymentEdu.xlsx")
#---------------------------------------------------------------------------------Unemplyment page layout-------------------------------------------------------------------------------
dataFliveli = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\OutSideLFcate.xlsx")
#---------------------------------------------------------------------------------Unemplyment page layout-------------------------------------------------------------------------------
OutLFReason = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\out side LF.xlsx")
#---------------------------------------------------------------------------------Unemplyment page layout-------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        dbc.Row([
            html.Div(
                [
                    html.H3("Population outside the labour force by main source of livelihood", style={'color': 'black', 'backgroundColor': '#2fc2df', 'padding': '10px'}),
                ],
                style={'textAlign': 'center'}
            ),
            dbc.Col([
                html.Div([
                    html.Div([
                        html.H3("tttttttttt", style={'fontSize':'20px','color': 'black','textAlign':'center', 'margin': '0 auto'})
                        ],className="border-start border-primary border-5 m-4", style={'height': '40px'}
                    ),
                    html.Hr(style={'color': 'black', 'width': '90%', 'margin': '0 auto'}),
                    html.Div([
                        html.H3("Select:",style={'fontSize':'16px'})
                    ],className='m-2'),
                    dcc.Dropdown(
                        id='categoryreos',
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            dbc.Col([
                ...
                ], style={'backgroundColor':'white','border': '2px solid #ccc', 'boxShadow': '0px 4px 8px rgba(0, 0, 0, 0.1)'}),
            ], width=6),
        ]),
        html.Br(),
    ],
