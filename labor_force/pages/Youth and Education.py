...
dfSun=pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Youth.xlsx")
#Scatter plot for NEET
df_youth_age = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Neetage_range.xlsx")

df_educational_level = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Neeteducation.xlsx")
...
TechT = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Technical training.xlsx")
# Dropdown options
...
EdAtt = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\education_attainment.xlsx")
...
layout = dbc.Container([
        ...
        dbc.Row([
            ...
            dbc.Col([
                ...
                #card 1---------------------------------------------------------------------------------------------------------------------------------------------------------- 
                html.Div([
                    html.H3("Population 16 years old by field of education", style={'fontSize':'20px','color': 'black','textAlign':'center', 'margin': '0 auto'})
                ],className="border-start border-primary border-5 m-4", style={'height': '40px','textAlign': 'center'}),
                html.Hr(style={'color': 'black', 'width': '90%', 'margin': '0 auto'}), 
                html.Br(),
                html.Div([
                ...
                #card 2----------------------------------------------------------------------------------------------------------------------------------------------------------   
                html.Div([
                    html.H3("Population 16 years old by Technical Training", style={'fontSize':'20px','color': 'black','textAlign':'center', 'margin': '0 auto'})
                ],className="border-start border-primary border-5 m-4", style={'height': '40px','textAlign': 'center'}),
                html.Hr(style={'color': 'black', 'width': '90%', 'margin': '0 auto'}), 
                html.Br(),
                html.Div([
