...
dfdisability2 = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\disability1.xlsx")
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------
#data for the pie chart on employment status among disabled persons
Disability2 = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\disability2.xlsx")
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------
#load the dataset for migration
Migrants = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Migrants.xlsx")
Internal_migrants = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\Internal_migrants.xlsx")
International_migrants = pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\International_migrants.xlsx")
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------
migrants=pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\df_migrants.xlsx")
internal_migrants=pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\df_internal_migrants.xlsx")
international_migrants=pd.read_excel(r"C:\Users\user\OneDrive\Documents\python works\labor_force\dataset\df_international_migrants.xlsx")
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        # Horizontal frame for the title for "Disabled Persons" section
            html.Div(
                [
                    html.H3("Migrant Population by Reason for moving and Employment Status", style={'color': 'black', 'backgroundColor': '#2fc2df', 'padding': '10px'}),
                ],
                style={'textAlign': 'center'}
            ),
        dbc.Row([
